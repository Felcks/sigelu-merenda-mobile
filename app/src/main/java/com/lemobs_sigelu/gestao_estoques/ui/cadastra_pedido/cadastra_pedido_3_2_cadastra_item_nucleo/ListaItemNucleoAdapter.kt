...
class ListaItemNucleoAdapter (private val context: Context,
                              private val list: List<ItemNucleo>,
                              private val remocaoItemClickListener: TwoIntParametersClickListener): RecyclerView.Adapter<ListaItemNucleoAdapter.MyViewHolder>() {
    ...
    private fun adicionarMascaras(item: ItemNucleo, holder: MyViewHolder, position: Int){
