...
import com.sigelu.merenda.extensions_constants.toHoraMinutoSegundo
...
class ListaEnvioAdapter(val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): TimeLineViewHolder {
        ...
        val view = mLayoutInflater.inflate(com.sigelu.merenda.R.layout.item_envio, parent, false)
    ...
    override fun onBindViewHolder(holder: TimeLineViewHolder, position: Int) {
        ...
        holder.itemView.arrow.background = if (isExpanded) ContextCompat.getDrawable(App.instance, com.sigelu.merenda.R.drawable.ic_arrow_up)
            else ContextCompat.getDrawable(App.instance, com.sigelu.merenda.R.drawable.ic_arrow_down)
        ...
        if(item.situacao == "Enviado"){
            holder.itemView.time_marker.setMarker(context.resources.getDrawable(com.sigelu.merenda.R.drawable.ic_marker_inactive))
        }
        else{
            holder.itemView.time_marker.setMarker(context.resources.getDrawable(com.sigelu.merenda.R.drawable.ic_marker_active))
        }
    }
    ...
    inner class TimeLineViewHolder(itemView: View, viewType: Int) : RecyclerView.ViewHolder(itemView) {
        ...
        private var mTimelineView: TimelineView = itemView.findViewById(com.sigelu.merenda.R.id.time_marker) as TimelineView
        init {
