...
import com.sigelu.logistica.ui.cadastra_envio.CadastraEnvioViewModelFactory
...
class SelecionaItemEnvioActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.sigelu.logistica.R.layout.activity_seleciona_item_envio)

        viewModel = ViewModelProviders.of(this, viewModelFactory).get(SelecionaItemEnvioViewModel::class.java)
        viewModel!!.response().observe(this, Observer<Response> { response -> processResponse(response) })

        val mainBinding: com.sigelu.logistica.databinding.ActivitySelecionaItemEnvioBinding = DataBindingUtil.setContentView(this, com.sigelu.logistica.R.layout.activity_seleciona_item_envio)
