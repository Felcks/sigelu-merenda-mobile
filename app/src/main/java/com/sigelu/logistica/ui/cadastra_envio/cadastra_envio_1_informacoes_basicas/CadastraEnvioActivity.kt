...
import com.sigelu.logistica.utils.Mask
...
class CadastraEnvioActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mainBinding: com.sigelu.logistica.databinding.ActivityCadastraEnvioBinding = DataBindingUtil.setContentView(this, R.layout.activity_cadastra_envio)
