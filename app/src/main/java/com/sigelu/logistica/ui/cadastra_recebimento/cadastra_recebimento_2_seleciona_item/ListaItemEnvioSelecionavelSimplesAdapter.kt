package com.sigelu.logistica.ui.cadastra_recebimento.cadastra_recebimento_2_seleciona_item
...
class ListaItemEnvioSelecionavelSimplesAdapter(private val context: Context,
                                               private val list: List<ItemEnvio>,
                                               private val itemClickListener: TwoIntParametersClickListener,
                                               private val itensJaCadastrados: List<Int>): RecyclerView.Adapter<ListaItemEnvioSelecionavelSimplesAdapter.MyViewHolder>() {
    ...
    val itemsParaAdicao = mutableListOf<ItemEnvio>()
    val itemsParaRemocao = mutableListOf<ItemEnvio>()
