...
class CadastraItemNucleoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mainBinding: com.sigelu.logistica.databinding.ActivityCadastraMaterialPedidoNucleoBinding = DataBindingUtil.setContentView(this, R.layout.activity_cadastra_material_pedido_nucleo)
