package com.sigelu.logistica.ui.cadastra_pedido.cadastra_pedido_4_2_confirma_nucleo
...
class ListaItemNucleoAdapter (val context: Context,
                                val list: List<ItemNucleo>):
    RecyclerView.Adapter<ListaItemNucleoAdapter.MyViewHolder>() {
