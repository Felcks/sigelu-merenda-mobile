...
import com.sigelu.logistica.exceptions.ListaVaziaException
import com.sigelu.logistica.extensions_constants.db
            ...
            if (response.isSuccessful && response.body() != null) {
                ...
                val itens = response.body()!!.map {
                    ...
                    val unidadeMedida = with(it.item_estoque.unidade_medida) {
                        com.sigelu.logistica.common.domain.model.UnidadeMedida(
                            this.id,
                            this.nome ?: "",
                            this.sigla ?: ""
                        )
                    ...
                    val itemEstoque = with(it.item_estoque) {
                        com.sigelu.logistica.common.domain.model.ItemEstoque(
                            this.id,
                            this.codigo ?: "",
                            this.descricao ?: "",
